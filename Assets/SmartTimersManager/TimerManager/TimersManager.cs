...
namespace Timers
{
    // The TimerManager manages all scheduled timers. This includes both the regular execution of timers,
    // as well as the cleanup of timers after garbage collection.
    ...
    public class TimersManager : MonoBehaviour
    {
        ...
        /// <param name="overrideOld">If true(default), then it overrides the previously set timer that points to the same action. 
        ///             Timers with the same ID (HashCode) will be overriden regardless.</param>
        ...
        /// </summary>
        /// <param name="owner">The object that contains the timer. 
        ///             Required in order to remove the timer if the object is destroyed.</param>
        ...
        /// </summary>
        /// <param name="owner">Owner of timers. This should be the object that have these timers. 
        ///             Required in order to remove the timers if the object is destroyed.</param>
        /// <param name="timers">Timers list</param>
        /// <param name="overrideOld">If true(default), then it overrides the previously set timers that point to the same action. 
        ///             Timers with the same ID will be overriden regardless.</param>
